import 'package:tarjetas_1/main.dart';
...
class HotelAppTheme {
  ...
  static ThemeData buildLightTheme() {
    ...
    return base.copyWith(
      ...
      hoverColor: const Color.fromARGB(255, 255, 0, 47),
      ...
      platform: TargetPlatform.iOS, colorScheme: colorScheme.copyWith(background: const Color.fromARGB(255, 255, 255, 255)),
    );
  }
}